...
class AnalysedPlayer:
    ...
    def assess(self):
        ...
        flags.append(self.accuracy_given_scaled_advantage(scaled_advantage = 150, scaled_threshold = 10) >= 95.0)
        flags.append(self.accuracy_given_advantage(advantage = 200, threshold = 30) >= 93.5)
        flags.append(self.accuracy_given_scaled_advantage(scaled_advantage = 200, scaled_threshold = 30) >= 95.0)
    ...
    def assess_rank_0_percents(self, averg = 60.0, maxim = 73.0, weights = {'mb': 0, 'homt': 99, 'mt': 9, 'ho': 99, 'mbmt': 99, 'hb': 21, 'hbmt': 99}):
        flags = []
